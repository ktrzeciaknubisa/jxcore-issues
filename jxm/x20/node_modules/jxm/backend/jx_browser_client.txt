...
(function(){
    ...
    jxcore.Call = function(methodName, json, cb, clientCB){
        ...
        console.log("Call() org", str);
        console.log("Call() encoded", encodeURIComponent(str));
        jxcore.Send(str);
    };
    ...
    jxcore.GoSockets = function(call_id) {
        ...
        if(jxcore.Socket==null) {
            ...
            jxcore.Socket.onmessage = function(ev) {
                ...
                {
                   jxcore.Notify(ee, "Cannot decode:" + ev.data);
                }
            }; 
        }
        ...
        if(jxcore.SocketOpen) {
        console.log("socket send ", jxcore.RequestList.s[call_id].message);
    ...
    jxcore._Send = function (call_id, cc) {
        ...
        if (call_id != -1) {
            try {
                if( jxcore.RequestList.s[call_id]!=null) {
                    txt.push('ms=' + encodeURIComponent(jxcore.RequestList.s[call_id].message));
                }
            } catch (e) {
                return;
            }
        ...
        xmlHttp.onreadystatechange = function () {
            ...
            if (rs == jxcore.CMode && (oStatus == 200 || oStatus == 304)) {
                ...
                try {
                    ...
                    if (_this.responseText != "") {
                        ...
                        //var smes = decodeURIComponent(_this.responseText);
            ...
            else if(rs == 4)
            {
                ...
                var smes="";
                if (_this.responseText != "") {
                    //smes = decodeURIComponent(_this.responseText);
