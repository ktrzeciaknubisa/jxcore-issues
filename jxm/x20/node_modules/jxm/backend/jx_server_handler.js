...
//console.trace();
  ...
  //      if (cnn.ms)
   //         jxcore.utils.console.log("handleHttp cnn.ms", cnn.ms, "red");
...
exports.handleSocket = function (cnn) {
    ...
    //if (cnn.ms && cnn.ms.indexOf("Hello") !== -1) {
    //    debugger;
    //    jxcore.utils.console.log("handleSocket cnn.ms", cnn.ms, "magenta");
    //}
...
var handleSocketSend = function (cnn) {
    //if (cnn.ms && cnn.ms.indexOf("Hello") !== -1) {
    //    jxcore.utils.console.log("handleSocketSend cnn.ms before unescape", cnn.ms, "cyan");
    //}

    // http messages are already unescaped
