    ...
    document.onjxready = function () {
        ...
        jxcore.OnSubscription = function (subscribed, group) {
            if (subscribed) {
                ...
                jxcore.SendToGroup(group, "clientsMethod", "Hello from browser German: ä ö ü Ä Ö Ü");
                jxcore.SendToGroup(group, "clientsMethod", "Hello from browser Chinese: 齈龘墻 儮嬼懫 瀷");
                jxcore.SendToGroup(group, "clientsMethod", "Hello from browser Russian: Эа эжт");
            }
        };
    };
</script>
